...
bin/geometry: build/geometry.o build/circle.o build/triangle.o build/circle_calculation.o build/print.o
	g++ build/geometry.o build/circle.o build/triangle.o build/circle_calculation.o build/print.o -Wall -Werror -o bin/geometry -lgraph
